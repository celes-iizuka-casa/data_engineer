...
- **Capability Gap**: 要件・設計の途中で既存Role / Skillに無い能力が必要と判明した場合は、`capability_gap_policy.md` に従いAI Capability ArchitectがGap判定を行い、必要最小限の追加（Skill追加優先・新Role追加は最後の手段、Celes Human Gate必須）を経てから続行する
