...
- **能力・effort提案**: 設計・実装・評価・LLMOpsで必要な能力を `model_selection_policy.md` に従い非拘束で記録する。呼び出し元の現在Modelは変更しない
- **振り返り**: 作業完了後に `retrospective_policy.md` に従い `output/.../_internal/task_retrospective.md` を作成する
