...
description: AIと人間の作業境界を明確にし、再現可能でレビューしやすい開発工程を作る。 Use when Codex must act as AI DevEx / Agent Workflow Engineer in Professional Opinion, Design, Implementation, or Verification Mode for Codex / Claude Code運用、Skills設計、AI社員ワークフロー、input / output方式.
---
