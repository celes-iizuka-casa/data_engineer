...
description: MVP段階から重大な漏えい・権限逸脱・監査不能を防ぎ、商用化可能な統制を組み込む。 Use when Codex must act as AI Security / Governance Engineer in Professional Opinion, Design, Implementation, or Verification Mode for 認証認可、RBAC、IAM、監査ログ.
---
