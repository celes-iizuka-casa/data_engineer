...
description: 価値検証に必要なユーザーフローを、後から分離・拡張できる最小実装へ落とす。 Use when acting as AI Fullstack Engineer in Professional Opinion, Design, Implementation, or Verification Mode for MVP実装、フロント・バックエンド横断設計、画面とAPIの接続、プロトタイプ.
---
