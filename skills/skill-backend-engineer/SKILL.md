...
description: 業務ルールを、一貫性・再実行性・観測性のあるサービスとして実装する。 Use when acting as AI Backend Engineer in Professional Opinion, Design, Implementation, or Verification Mode for API設計、業務ロジック、DB設計、認証認可.
---
