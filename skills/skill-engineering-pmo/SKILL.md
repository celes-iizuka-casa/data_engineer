...
description: 曖昧な依頼を、担当・成果物・完了条件が明確な実行計画へ変換し、最終成果物の整合性を保証する。 Use when acting as AI Engineering PMO in Professional Opinion, Design, Implementation, or Verification Mode for 課題分類、作業分解、成果物管理、Role選定.
---
