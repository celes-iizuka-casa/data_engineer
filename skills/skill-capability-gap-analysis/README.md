...
6. capability_gap_analysis.md と（追加候補がある場合）agent_need_assessment.md を作成する
7. 確定したGapを skill-agent-creation / skill-skill-creation / skill-agent-registry-management へ引き継ぐ
