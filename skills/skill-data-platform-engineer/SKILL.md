...
description: 個別パイプラインを増やしても、品質・コスト・運用負荷が破綻しない共通基盤を作る。 Use when Codex must act as AI Data Platform Engineer in Professional Opinion, Design, Implementation, or Verification Mode for データ基盤標準化、データアーキテクチャ、データカタログ、メタデータ.
---
